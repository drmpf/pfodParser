...
# Revisions 
Version 5.1.11 pfodWeb V4.1.13 pfodCircularLineBuffer: added getReadCursor()/setReadCursor() for exact resumable reads across long-lived buffers (absolute write-count based, not a wrapped-index guess); extended pfodParserAI-guide.md to cover pfodCircularLineBuffer alongside pfodDelay  
